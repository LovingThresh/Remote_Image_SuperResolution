...
# @File    : model.py
# @Software: PyCharm
# @From    : https://github.com/xindongzhang/ECBSR/blob/main/models/ecbsr.py
import torch
import functools
import numpy as np
...
class ECBSR(nn.Module):
    def __init__(self, module_nums, channel_nums, with_idt, act_type, scale, colors):
        ...
        backbone += [
            ECB(self.channel_nums, self.colors * self.scale * self.scale, depth_multiplier=2.0, act_type='linear',
                with_idt=self.with_idt)]
